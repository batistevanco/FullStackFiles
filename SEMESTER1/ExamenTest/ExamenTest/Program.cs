...
using ExamenTest.Repository;
using ExamenTest.Repository.Interfaces;
using ExamenTest.Services;
...
builder.Services.AddScoped<IDAO<Breweries2>, BreweryDAO>();

// Services
builder.Services.AddScoped<IBeerService, BeerService>();
builder.Services.AddScoped<IService<Breweries2>, BreweryService>();
